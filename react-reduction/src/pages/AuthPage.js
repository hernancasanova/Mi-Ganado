...
class AuthPage extends React.Component {
  ...
  componentDidUpdate(){
    console.log("componentDidUpdate AuthPage");
  ...
  render() {
    //const api_token=localStorage.getItem('api_token');
    const {loading, api_token, authState}=this.props;
    return (<>{loading?<PageSpinner texto={authState===STATE_LOGIN?"Iniciando sesión":"Registrando nuevo usuario"} />:
      <Row
        style={{
          height: '100vh',
